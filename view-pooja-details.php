...
<html>
<head>
<title>	Online Temple Management System | | Pooja History</title>
...
<tr>
 ...
 <tr class="table-danger">
    <th>Date of Pooja</th>
    <td colspan="3"><?php echo htmlentities($row['DateOfPooja']);?></td>
...
<tr class="table-danger">
    <th>Pooja Name</th>
    <td><?php echo htmlentities($row['PoojaName']);?></td>
