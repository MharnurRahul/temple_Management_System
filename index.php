...
<html>
<head>
<title>	Online Temple Management System || Home Page</title>
...
$ret=mysqli_query($con,"select *from  temple");
$cnt=1;
...
?>
								<li>
									...
									<div class="team1">
										<img src="admin/templeimages/<?php echo htmlentities($row['TempleImage1']);?>" class="img-responsive" width="300" height="200" alt="" />
									</div>
								</li><?php 
$cnt=$cnt+1;
}?>
	...
	<a href="single.html" class="vie">View All</a>
<!-- recent -->
