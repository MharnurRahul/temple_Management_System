...
$ret=mysqli_query($con,"select temple.ID,temple.TempleName,tblfestivals.ID as fid,tblfestivals.TempleID,tblfestivals.FestivalName,tblfestivals.Date,tblfestivals.Day,tblfestivals.Description,tblfestivals.TempleImage1 from  tblfestivals join temple on temple.ID=tblfestivals.TempleID Order by tblfestivals.Date LIMIT $offset, $total_records_per_page");
$cnt=1; ?>
